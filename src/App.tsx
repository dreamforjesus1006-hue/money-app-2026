...
const STORAGE_KEY = 'baozutang_data_v29_stable'; 
...
const App: React.FC = () => {
  ...
  // Calculations (修正順序：先算 Metrics，再算 Radar)
  ...
  // 這裡修正了：fireMetrics 放在 radarData 之前
  ...
  return (
    <div className={`min-h-screen p-4 md:p-8 font-sans bg-slate-900 text-white selection:bg-emerald-500/30`}>
      ...
      <header className="mb-8 border-b border-slate-700 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           <h1 className="text-3xl font-bold text-emerald-400 flex items-center gap-2"><Calculator className="w-8 h-8" /> 包租唐戰情室 <span className="text-xs bg-emerald-900/50 text-emerald-200 px-2 py-0.5 rounded border border-emerald-500/30">V29 Final</span></h1>
